export type ServiceLanding = {
  ...
  export const SERVICES: Record<string, ServiceLanding> = {
    ...
    grundreinigung: {
      ...
      ctaSubtitle: 'Buchen Sie jetzt Ihre Grundreinigung in Deutschland in nur wenigen Klicks.',
    ...
    umzugsreinigung: {
      ...
      ctaSubtitle: 'Buchen Sie jetzt Ihre Umzugsreinigung in Deutschland in nur wenigen Klicks.',
      ctaButton: 'Jetzt Umzugsreinigung buchen',
      heroImage: '/images/WhatsApp Image 2026-07-21 at 22.11.48.jpeg',
    },
  };