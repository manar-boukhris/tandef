...
export default function Page() {
  ...
  useEffect(() => {
    document.title = "TANDEF – Küche allgemein reinigen";
    ...
    <>
      ...
      <section className="max-w-7xl mx-auto px-6 pt-6">
        <nav className="breadcrumb flex items-center gap-2 flex-wrap">
          ...
          <span>&gt;</span>
          <span>Küche allgemein reinigen</span>
        </nav>
      </section>
        ...
        <div className="article-hero flex flex-col lg:flex-row lg:min-h-[440px]">
          <div className="lg:w-1/2 p-8 md:p-12 flex flex-col justify-center">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold leading-tight mt-4 mb-5" style={{color: 'var(--ink)'}}>
              Küche allgemein reinigen
            </h1>
            <p className="text-base mb-6 max-w-md" style={{color: 'var(--muted)'}}>
              Eine saubere Küche sorgt für mehr Hygiene, ein angenehmes Kochgefühl und ein schönes Zuhause. Mit diesen einfachen Schritten reinigst du deine Küche gründlich und effizient.
            </p>
            <div className="handwrite">Saubere Kiche.<br />Mehr Wohlbefinden.</div>
          </div>
          <div className="lg:w-1/2 h-56 sm:h-64 lg:h-auto overflow-hidden">
            <img src="/images/magazin-kueche-allgemein.png" alt="Küche allgemein reinigen" className="w-full h-full object-cover block article-hero-img" />
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <h2 className="text-2xl font-bold mb-2" style={{color: 'var(--ink)'}}>Schritt für Schritt zu einer sauberen Küche</h2>
        <p className="text-sm mb-8" style={{color: 'var(--muted)'}}>Folge diesen einfachen Schritten, um deine Küche gründlich zu reinigen.</p>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-10">
          <div className="step-vcard">
           ...
           <img src="/images/magazin-kueche-letzte-bereich.png" className="w-full h-full object-cover" />
           </div>
            <p className="font-bold text-sm mb-1.5" style={{color: "var(--ink)"}}>Aufräumen</p>
            <p className="text-xs" style={{color: "var(--muted)"}}>Räume die Arbeitsflächen frei und stelle Gegenstände an ihren Platz. So kannst du alle Flächen gründlich reinigen.</p>
          </div>
          <div className="step-vcard">
            <span className="step-num mb-3">02</span>
            <div className="step-vtile" style={{background: "#EAF2FE"}}>
            <img src="/images/yed.jpg" className="w-full h-full object-cover" /></div>
            <p className="font-bold text-sm mb-1.5" style={{color: "var(--ink)"}}>Oberflächen reinigen</p>
            <p className="text-xs" style={{color: "var(--muted)"}}>Wische Arbeitsplatten, Tische und andere Oberflächen mit einem geeigneten Reinigungsmittel ab. Entferne dabei Staub, Fett und Essensreste.</p>
          </div>
          <div className="step-vcard">
            <span className="step-num mb-3">03</span>
            <div className="step-vtile" style={{background: "#FDF6E3"}}>
            
            <img src="/images/tarf.png" className="w-full h-full object-cover" />
            </div>
            <p className="font-bold text-sm mb-1.5" style={{color: "var(--ink)"}}>Schränke und Griffe</p>
            <p className="text-xs" style={{color: "var(--muted)"}}>Reinige die Schrankfronten, Türen und Griffe. Achte auf Fingerabdrücke und Fettspuren, besonders in der Nähe des Herds.</p>
          </div>
          <div className="step-vcard">
            <span className="step-num mb-3">04</span>
            <div className="step-vtile" style={{background: "#EAF2FE"}}>
            <img src="/images/magazin-hub/kueche.jpg" className="w-full h-full object-cover" /></div>
            <p className="font-bold text-sm mb-1.5" style={{color: "var(--ink)"}}>Spüle reinigen</p>
            <p className="text-xs" style={{color: "var(--muted)"}}>Säubere die Spüle gründlich und entferne Kalk- und Wasserflecken. Trockne die Armatur anschließend mit einem sauberen Tuch.</p>
          </div>
          <div className="step-vcard">
            <span className="step-num mb-3">05</span>
            <div className="step-vtile" style={{background: "#FDEBF0"}}>
             <img src="/images/nachhaltigkeit/hub/tile-dosieren.png" className="w-full h-full object-cover" />
             </div>
            <p className="font-bold text-sm mb-1.5" style={{color: "var(--ink)"}}>Wandflächen</p>
            <p className="text-xs" style={{color: "var(--muted)"}}>Entferne Spritzer und Flecken an der Rückwand (Fliesen oder Glas) mit einem geeigneten Reiniger.</p>
          </div>
          <div className="step-vcard">
            <span className="step-num mb-3">06</span>
            <div className="step-vtile" style={{background: "#FDF1E3"}}>
             
             <img src="/images/magazin-kueche-herd.png" className="w-full h-full object-cover" />
             </div>
            <p className="font-bold text-sm mb-1.5" style={{color: "var(--ink)"}}>Kochfeld</p>
            <p className="text-xs" style={{color: "var(--muted)"}}>Reinige das Kochfeld mit einem passenden Reiniger und einem weichen Tuch. Entferne eingebrannte Rückstände vorsichtig.</p>
          </div>
          <div className="step-vcard">
            ...
            <p className="text-xs" style={{color: "var(--muted)"}}>Zum Schluss den Boden saugen oder feucht wischen. Achte auch auf Bereiche unter dem Tisch und um den Mülleimer.</p>
          </div>
          <div className="step-vcard">
            <span className="step-num mb-3">08</span>
            <div className="step-vtile" style={{background: "var(--purple-50)"}}>
             <img src="/images/magazin-kueche-zubehoer.png" className="w-full h-full object-cover" />
            </div>
            <p className="font-bold text-sm mb-1.5" style={{color: "var(--ink)"}}>Fertig!</p>
            <p className="text-xs" style={{color: "var(--muted)"}}>Deine Küche ist jetzt sauber, frisch und bereit für neue Genussmomente.</p>
          </div>
        </div>
        ...
        <div className="tip-banner flex items-center justify-between gap-6 p-7 md:p-8 overflow-hidden">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="font-bold text-lg mt-2 max-w-md leading-snug" style={{color: 'var(--ink)'}}>Von oben nach unten reinigen.</p>
              <p className="text-sm mt-1 max-w-md" style={{color: 'var(--muted)'}}>So fällt Staub und Schmutz nicht auf bereits gereinigte Flächen.</p>
            </div>
          </div>
