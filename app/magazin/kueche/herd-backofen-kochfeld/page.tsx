...
export default function Page() {
  ...
  useEffect(() => {
    document.title = "TANDEF – Herd, Backofen & Kochfeld reinigen";
    ...
    <>
      ...
      <section className="max-w-7xl mx-auto px-6 pt-6">
        <nav className="breadcrumb flex items-center gap-2 flex-wrap">
          ...
          <span>&gt;</span>
          <span>Herd, Backofen &amp; Kochfeld reinigen</span>
        </nav>
      </section>
        ...
        <div className="article-hero flex flex-col lg:flex-row lg:min-h-[440px]">
          <div className="lg:w-1/2 p-8 md:p-12 flex flex-col justify-center">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold leading-tight mt-4 mb-5" style={{color: 'var(--ink)'}}>
              Herd, Backofen &amp; Kochfeld reinigen
            </h1>
            <p className="text-base mb-6 max-w-md" style={{color: 'var(--muted)'}}>
              Ein sauberer Herd und Backofen sorgen nicht nur für mehr Hygiene, sondern auch für ein besseres Kochergebnis und eine längere Lebensdauer. Mit den richtigen Schritten entfernst du Fett, eingebrannte Rückstände und Schmutz zuverlässig.
            </p>
            <div className="handwrite">Saubere Geräte.<br />Mehr Freude am Kochen.</div>
          </div>
          <div className="lg:w-1/2 h-56 sm:h-64 lg:h-auto overflow-hidden">
            <img src="/images/magazin-kueche-herd.png" alt="Herd, Backofen & Kochfeld" className="w-full h-full object-cover block article-hero-img" />
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <h2 className="text-2xl font-bold mb-2" style={{color: 'var(--ink)'}}>Schritt für Schritt zu sauberen Kochgeräten</h2>
        <p className="text-sm mb-8" style={{color: 'var(--muted)'}}>So reinigst du Herd, Backofen und Kochfeld gründlich und effektiv.</p>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-10">
          <div className="step-vcard">
            ...
            <img src="/images/gaz.png" className="w-full h-full object-cover" />
            </div>
            <p className="font-bold text-sm mb-1.5" style={{color: "var(--ink)"}}>Herd reinigen</p>
            <p className="text-xs" style={{color: "var(--muted)"}}>Entferne abnehmbare Teile wie Roste und Brenner und wasche sie mit warmem Wasser und Spülmittel. Wische die Oberfläche mit einem geeigneten Fettlöser ab und trockne sie anschließend.</p>
          </div>
          <div className="step-vcard">
            ...
            <p className="font-bold text-sm mb-1.5" style={{color: "var(--ink)"}}>Kochfeld reinigen</p>
            <p className="text-xs" style={{color: "var(--muted)"}}>Verwende einen speziellen Reiniger für Glaskeramik oder Induktion. Entferne Schmutz und Fett mit einem weichen Tuch und achte darauf, keine kratzenden Schwämme zu verwenden.</p>
          </div>
          <div className="step-vcard">
            <span className="step-num mb-3">03</span>
            <div className="step-vtile" style={{background: "#FDEBF0"}}>
             
             <img src="/images/3a.png" className="w-full h-full object-cover" />
             </div>
            <p className="font-bold text-sm mb-1.5" style={{color: "var(--ink)"}}>Backofen reinigen</p>
            <p className="text-xs" style={{color: "var(--muted)"}}>Löse eingebrannte Rückstände mit einem Backofenreiniger oder einer natürlichen Lösung (z. B. Natron und Wasser). Lasse das Mittel einwirken und wische die Flächen anschließend mit einem feuchten Tuch aus.</p>
          </div>
          <div className="step-vcard">
            <span className="step-num mb-3">04</span>
            <div className="step-vtile" style={{background: "#FDF6E3"}}>
            
            <img src="/images/tarfgaz.png" className="w-full h-full object-cover" />
            </div>
            <p className="font-bold text-sm mb-1.5" style={{color: "var(--ink)"}}>Regler und Bedienfeld</p>
            <p className="text-xs" style={{color: "var(--muted)"}}>Wische die Knöpfe und das Bedienfeld mit einem leicht feuchten Tuch. Entferne Fett und Fingerabdrücke und trockne alles gründlich nach.</p>
          </div>
        </div>
          ...
          <div className="tip-banner p-6">
            <div className="flex items-center gap-2.5 mb-3">
              <span className="tip-icon-circle" style={{width: 34, height: 34}}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#5B21B6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M11 20A7 7 0 019.8 6.1C15.5 5 17 3.5 18.5 2c1 6 2.5 12-2 16-2.5 2.5-7 2.5-9.5 0" /></svg>
              </span>
              <span className="tag" style={{background: 'var(--purple-100)', color: 'var(--purple-700)'}}>TANDEF-Tipp</span>
            </div>
            <p className="font-bold mb-2" style={{color: 'var(--ink)'}}>Natürliche Reinigung</p>
            <p className="text-sm" style={{color: 'var(--muted)'}}>Für leichte Verschmutzungen eignen sich Hausmittel wie Natron, Essig oder Zitronensaft. Sie sind effektiv, umweltfreundlich und schonen die Oberfläche.</p>
          </div>
        ...
        <div className="hinweise-box p-6">
          ...
          <ul className="space-y-3 text-sm" style={{color: 'var(--muted)'}}>
            <li className="flex items-start gap-2.5"><span className="hinweise-check mt-0.5"><svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="3"><path d="M20 6L9 17l-5-5" /></svg></span>Geräte vor der Reinigung ausschalten und abkühlen lassen.</li>
            <li className="flex items-start gap-2.5"><span className="hinweise-check mt-0.5"><svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="3"><path d="M20 6L9 17l-5-5" /></svg></span>Keine kratzenden Schwämme oder aggressive Mittel verwenden.</li>
            <li className="flex items-start gap-2.5"><span className="hinweise-check mt-0.5"><svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="3"><path d="M20 6L9 17l-5-5" /></svg></span>Herstellerhinweise beachten.</li>
            <li className="flex items-start gap-2.5"><span className="hinweise-check mt-0.5"><svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="3"><path d="M20 6L9 17l-5-5" /></svg></span>Nach der Reinigung alle Flächen trocken wischen.</li>
          </ul>
        </div>
        </div>
        ...
        <div className="tip-banner flex items-center justify-between gap-6 p-7 md:p-8 overflow-hidden">
          <div>
            <p className="font-bold text-lg mb-1" style={{color: 'var(--ink)'}}>Regelmäßige Reinigung lohnt sich.</p>
            <p className="text-sm max-w-md" style={{color: 'var(--muted)'}}>Ein sauberer Herd und Backofen sehen nicht nur besser aus, sondern sorgen auch für mehr Sicherheit und eine längere Lebensdauer.</p>
          </div>
          <img src="/images/plante.png" alt="" className="hidden md:block pointer-events-none select-none h-36 w-auto shrink-0 -my-6" />
        </div>
      </section>
