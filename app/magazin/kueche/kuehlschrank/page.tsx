...
export default function Page() {
  ...
  useEffect(() => {
    document.title = "TANDEF – Kühlschrank reinigen";
    ...
    <>
      ...
      <section className="max-w-7xl mx-auto px-6 pt-6">
        <nav className="breadcrumb flex items-center gap-2 flex-wrap">
          ...
          <span>&gt;</span>
          <span>Kühlschrank reinigen</span>
        </nav>
      </section>
        ...
        <div className="article-hero flex flex-col lg:flex-row lg:min-h-[440px]">
          <div className="lg:w-1/2 p-8 md:p-12 flex flex-col justify-center">
            ...
            <p className="text-base mb-6 max-w-md" style={{color: 'var(--muted)'}}>
              Ein sauberer Kühlschrank sorgt für frische Lebensmittel, verhindert unangenehme Gerüche und trägt zu mehr Hygiene in deiner Küche bei. Mit unserer Schritt-für-Schritt-Anleitung reinigst du deinen Kühlschrank gründlich und einfach.
            </p>
            <div className="handwrite">Frische beginnt<br />mit Sauberkeit.</div>
          </div>
          <div className="lg:w-1/2 h-56 sm:h-64 lg:h-auto overflow-hidden">
            <img src="/images/magazin-kueche-kuehlschrank.png" alt="Kühlschrank reinigen" className="w-full h-full object-cover block article-hero-img" />
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <h2 className="text-2xl font-bold mb-2" style={{color: 'var(--ink)'}}>Schritt für Schritt zu einem sauberen Kühlschrank</h2>
        <p className="text-sm mb-8" style={{color: 'var(--muted)'}}>Folge diesen einfachen Schritten, um deinen Kühlschrank gründlich zu reinigen.</p>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-10">
          <div className="step-vcard">
            ...
            <div className="step-vtile" style={{background: "var(--purple-50)"}}>
             ...
             <img src="/images/f1.png" className="w-full h-full object-cover" />
             </div>
            <p className="font-bold text-sm mb-1.5" style={{color: "var(--ink)"}}>Kühlschrank ausräumen</p>
            <p className="text-xs" style={{color: "var(--muted)"}}>Nimm alle Lebensmittel heraus und überprüfe das Mindesthaltbarkeitsdatum. Entsorge abgelaufene Produkte.</p>
          </div>
          <div className="step-vcard">
            <span className="step-num mb-3">02</span>
            <div className="step-vtile" style={{background: "#EAF2FE"}}>
            
            <img src="/images/f2.png" className="w-full h-full object-cover" />
            </div>
            <p className="font-bold text-sm mb-1.5" style={{color: "var(--ink)"}}>Herausnehmbare Teile entfernen</p>
            <p className="text-xs" style={{color: "var(--muted)"}}>Nimm alle herausnehmbaren Fächer, Glasplatten und Schubladen heraus, um sie separat zu reinigen.</p>
          </div>
          <div className="step-vcard">
            ...
            <p className="font-bold text-sm mb-1.5" style={{color: "var(--ink)"}}>Innenraum reinigen</p>
            <p className="text-xs" style={{color: "var(--muted)"}}>Wische die Innenflächen mit einem milden Reinigungsmittel (z. B. Wasser mit etwas Essig) und einem weichen Tuch aus. Achte besonders auf Ecken und Dichtungen.</p>
          </div>
          <div className="step-vcard">
            <span className="step-num mb-3">04</span>
            <div className="step-vtile" style={{background: "#FDF6E3"}}>
            
            <img src="/images/f4.png" className="w-full h-full object-cover" />
            </div>
            <p className="font-bold text-sm mb-1.5" style={{color: "var(--ink)"}}>Fächer und Glasplatten reinigen</p>
            <p className="text-xs" style={{color: "var(--muted)"}}>Reinige die herausgenommenen Teile mit warmem Wasser und etwas Spülmittel. Lasse sie anschließend gut trocknen, bevor du sie wieder einsetzt.</p>
          </div>
          <div className="step-vcard">
            <span className="step-num mb-3">05</span>
            <div className="step-vtile" style={{background: "#EAF2FE"}}>
             
             <img src="/images/f5.png" className="w-full h-full object-cover" />
             </div>
            <p className="font-bold text-sm mb-1.5" style={{color: "var(--ink)"}}>Türdichtung reinigen</p>
            <p className="text-xs" style={{color: "var(--muted)"}}>Reinige die Gummidichtung gründlich mit einem feuchten Tuch. So verhinderst du Schimmel und hältst die Dichtung geschmeidig.</p>
          </div>
          <div className="step-vcard">
            ...
            <p className="font-bold text-sm mb-1.5" style={{color: "var(--ink)"}}>Außenseiten reinigen</p>
            <p className="text-xs" style={{color: "var(--muted)"}}>Wische die Außenflächen, Griffe und Bedienelemente mit einem geeigneten Reiniger. Entferne Fingerabdrücke und Flecken gründlich.</p>
          </div>
          <div className="step-vcard">
            <span className="step-num mb-3">07</span>
            <div className="step-vtile" style={{background: "#F5F3FF"}}>
            
            <img src="/images/f7.png" className="w-full h-full object-cover" />
            </div>
            <p className="font-bold text-sm mb-1.5" style={{color: "var(--ink)"}}>Teile einsetzen</p>
            <p className="text-xs" style={{color: "var(--muted)"}}>Setze alle gereinigten und trockenen Fächer, Glasplatten und Schubladen wieder in den Kühlschrank ein.</p>
          </div>
          <div className="step-vcard">
            <span className="step-num mb-3">08</span>
            <div className="step-vtile" style={{background: "#E7F7EE"}}>
             
             <img src="/images/magazin-kueche-kuehlschrank.png" className="w-full h-full object-cover" />
             </div>
            <p className="font-bold text-sm mb-1.5" style={{color: "var(--ink)"}}>Lebensmittel einräumen</p>
            <p className="text-xs" style={{color: "var(--muted)"}}>Stelle die Lebensmittel geordnet zurück und achte auf eine gute Übersicht. So bleibt dein Kühlschrank länger frisch und sauber.</p>
          </div>
        </div>
        ...
        <div className="tip-banner flex items-center justify-between gap-6 p-7 md:p-8 overflow-hidden">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="font-bold text-lg mt-2 max-w-md leading-snug" style={{color: 'var(--ink)'}}>Regelmäßige Reinigung lohnt sich.</p>
              <p className="text-sm mt-1 max-w-md" style={{color: 'var(--muted)'}}>Reinige deinen Kühlschrank am besten alle 4–6 Wochen – so bleiben deine Lebensmittel länger frisch und die Hygiene in deiner Küche auf einem hohen Niveau.</p>
            </div>
          </div>
