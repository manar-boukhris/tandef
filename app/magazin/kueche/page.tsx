...
export default function Page() {
  ...
  useEffect(() => {
    document.title = "TANDEF – Küche richtig reinigen";
  ...
  return (
    <>
        ...
        <div className="article-hero flex flex-col lg:flex-row lg:min-h-[440px]">
          <div className="lg:w-1/2 p-8 md:p-12 flex flex-col justify-center">
            ...
            <p className="text-base mb-6 max-w-md" style={{color: 'var(--muted)'}}>
              Eine saubere Küche sorgt für mehr Hygiene, ein besseres Wohlbefinden und macht das Kochen noch angenehmer. Mit den richtigen Tipps bleibt deine Küche stets gepflegt und einladend.
            </p>
            <div className="handwrite">Kleine Tipps.<br />Große Wirkung.</div>
          </div>
          <div className="lg:w-1/2 h-56 sm:h-64 lg:h-auto overflow-hidden">
            <img src="/images/magazin-kueche-hero.png" alt="Küche" className="w-full h-full object-cover block article-hero-img" />
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <h2 className="text-2xl font-bold mb-2" style={{color: 'var(--ink)'}}>Unsere Küchenbereiche</h2>
        <p className="text-sm mb-8" style={{color: 'var(--muted)'}}>Wähle den Bereich, der dich interessiert:</p>

        <div className="grid sm:grid-cols-2 gap-5 mb-10">
          <a href="/magazin/kueche/allgemein" className="category-card block">
            <div className="category-card-img">
              <img src="/images/magazin-kueche-allgemein.png" alt="Küche allgemein reinigen" className="w-full h-full object-cover" />
            </div>
            <div className="p-6 pt-5 flex items-center justify-between gap-4">
              <div>
                <p className="font-bold mb-1" style={{color: 'var(--ink)'}}>Küche allgemein reinigen</p>
                <p className="text-sm" style={{color: 'var(--muted)'}}>So reinigst du Arbeitsflächen, Schränke, Griffe und andere Oberflächen gründlich und einfach.</p>
              </div>
          ...
          <a href="/magazin/kueche/herd-backofen-kochfeld" className="category-card block">
            <div className="category-card-img">
              <img src="/images/magazin-kueche-herd.png" alt="Herd, Backofen & Kochfeld" className="w-full h-full object-cover" />
            </div>
            <div className="p-6 pt-5 flex items-center justify-between gap-4">
              <div>
                <p className="font-bold mb-1" style={{color: 'var(--ink)'}}>Herd, Backofen &amp; Kochfeld</p>
                <p className="text-sm" style={{color: 'var(--muted)'}}>Entferne Fett und eingebrannte Rückstände und halte Herd, Backofen und Kochfeld hygienisch sauber.</p>
              </div>
              <span className="category-arrow">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 18l6-6-6-6" /></svg>
              </span>
          ...
          <a href="/magazin/kueche/kuehlschrank" className="category-card block">
            <div className="category-card-img">
              <img src="/images/magazin-kueche-kuehlschrank.png" alt="Kühlschrank reinigen" className="w-full h-full object-cover" />
            </div>
            <div className="p-6 pt-5 flex items-center justify-between gap-4">
              <div>
                <p className="font-bold mb-1" style={{color: 'var(--ink)'}}>Kühlschrank reinigen</p>
                <p className="text-sm" style={{color: 'var(--muted)'}}>So bleibt dein Kühlschrank frisch, geruchsfrei und hygienisch – für länger haltbare Lebensmittel.</p>
              </div>
              <span className="category-arrow">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 18l6-6-6-6" /></svg>
              </span>
          ...
          <a href="/magazin/kueche/der-letzte-bereich" className="category-card block">
            <div className="category-card-img">
              <img src="/images/magazin-kueche-zubehoer.png" alt="Weitere Tipps & Zubehör" className="w-full h-full object-cover" />
            </div>
            <div className="p-6 pt-5 flex items-center justify-between gap-4">
              <div>
                <p className="font-bold mb-1" style={{color: 'var(--ink)'}}>Weitere Tipps &amp; Zubehör</p>
                <p className="text-sm" style={{color: 'var(--muted)'}}>Nützliche Tipps, empfohlene Reinigungsmittel und kleine Tricks für eine dauerhaft saubere Küche.</p>
              </div>
              <span className="category-arrow">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 18l6-6-6-6" /></svg>
              </span>
        ...
        <div className="tip-banner flex items-center justify-between gap-6 p-7 md:p-8 overflow-hidden">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="font-bold text-lg mt-2 max-w-md leading-snug" style={{color: 'var(--ink)'}}>Regelmäßige Reinigung spart Zeit und Mühe.</p>
              <p className="text-sm mt-1 max-w-md" style={{color: 'var(--muted)'}}>Schon wenige Minuten am Tag reichen, um deine Küche dauerhaft sauber zu halten.</p>
            </div>
          </div>
