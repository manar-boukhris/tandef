...
export default function Page() {
  ...
  useEffect(() => {
    document.title = "TANDEF – Schlafzimmer richtig reinigen";
        ...
        <div className="article-hero grid lg:grid-cols-2 gap-0 items-center">
          <div className="p-8 md:p-12">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold leading-tight mt-4 mb-5" style={{color: 'var(--ink)'}}>
              Schlafzimmer richtig reinigen
            </h1>
            <p className="text-base mb-6 max-w-md" style={{color: 'var(--muted)'}}>
              So bleibt dein Schlafzimmer sauber, ordentlich und ein Ort zum Wohlfühlen. Mit wenigen Schritten erzielst du einen großen Unterschied.
            </p>
            <div className="handwrite">Kleine Tipps.<br />Große Wirkung.</div>
          </div>
          <div className="h-64 lg:h-full">
            <img src="/images/magazin-wohnen-schlafzimmer.jpg" alt="Schlafzimmer" className="w-full h-full object-cover article-hero-img" />
          </div>
        </div>
      </section>
        ...
        <div className="grid sm:grid-cols-2 gap-5 mb-10">
          <div className="step-card grid grid-cols-2 items-stretch">
            <div className="p-6 flex flex-col justify-center">
              ...
              <p className="font-bold mb-2" style={{color: 'var(--ink)'}}>Ordnung schaffen</p>
              <p className="text-sm" style={{color: 'var(--muted)'}}>Räume herumliegende Gegenstände weg und lege alles an seinen Platz. So kannst du besser und schneller reinigen.</p>
            </div>
            <div className="flex items-center justify-center" style={{background: 'var(--purple-50)', minHeight: '160px'}}>
            <img src="/images/ktob.jpg"  className="w-full h-full object-cover" />
          ...
          <div className="step-card grid grid-cols-2 items-stretch">
            <div className="p-6 flex flex-col justify-center">
              ...
              <p className="text-sm" style={{color: 'var(--muted)'}}>Arbeite von oben nach unten. Entferne Staub von Möbeln, Lampen, Bilderrahmen und allen Oberflächen mit einem geeigneten Tuch.</p>
            </div>
          ...
          <div className="step-card grid grid-cols-2 items-stretch">
            <div className="p-6 flex flex-col justify-center">
              ...
              <p className="font-bold mb-2" style={{color: 'var(--ink)'}}>Bett &amp; Textilien</p>
              <p className="text-sm" style={{color: 'var(--muted)'}}>Wechsle die Bettwäsche regelmäßig und lüfte Decken und Kissen. Wasche Vorhänge und andere Textilien nach Bedarf.</p>
            </div>
            <div className="flex items-center justify-center" style={{background: '#FDEBF0', minHeight: '160px'}}>
            <img src="/images/mkada.jpg"className="w-full h-full object-cover"  /></div>
          </div>
          ...
          <div className="step-card grid grid-cols-2 items-stretch">
            ...
            <img src="/images/asp.jpg"className="w-full h-full object-cover"  /></div>
          </div>
        </div>
        ...
        <div className="tip-banner flex items-center justify-between gap-6 p-7 md:p-8">
          <div className="flex items-start gap-4">
            <span className="tip-icon-circle">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#5B21B6" strokeWidth="2"><path d="M9 18h6M10 22h4M12 2a6 6 0 00-3.6 10.8c.5.4.8 1 .8 1.7V15h5.6v-.5c0-.7.3-1.3.8-1.7A6 6 0 0012 2z" /></svg>
            </span>
            <div>
              <span className="tag" style={{background: 'var(--purple-100)', color: 'var(--purple-700)'}}>TANDEF-Tipp</span>
              <p className="font-bold text-lg mt-2 max-w-md leading-snug" style={{color: 'var(--ink)'}}>Beginne immer von oben nach unten – so musst du nichts zweimal reinigen.</p>
            </div>
          </div>
          <div className="hidden md:block handwrite text-right shrink-0">Ein aufgeräumtes Schlafzimmer<br />sorgt für mehr Ruhe<br />und Lebensqualität.</div>
        </div>
      </section>
