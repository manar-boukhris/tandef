...
export default function Page() {
  ...
  useEffect(() => {
    document.title = "TANDEF – Weitere Räume";
  ...
  return (
    <>
        ...
        <div className="article-hero flex flex-col lg:flex-row lg:min-h-[440px]">
          <div className="lg:w-1/2 p-8 md:p-12 flex flex-col justify-center">
            ...
            <p className="text-base mb-6 max-w-md" style={{color: 'var(--muted)'}}>
              Auch kleinere Räume verdienen die richtige Pflege. Mit wenigen Handgriffen bleiben alle Bereiche deines Zuhauses sauber, ordentlich und einladend.
            </p>
          ...
          <div className="lg:w-1/2 h-56 sm:h-64 lg:h-auto overflow-hidden relative">
            <img src="/images/magazin-wohnen-weitere-raeume.jpg" alt="Weitere Räume" className="w-full h-full object-cover block article-hero-img" />
            <span className="handwrite hidden lg:block absolute top-6 right-8 text-white text-right" style={{textShadow: '0 2px 10px rgba(0,0,0,.25)'}}>
              Jeder Raum macht<br />dein Zuhause besonderer.♡
            </span>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <h2 className="text-2xl font-bold mb-2" style={{color: 'var(--ink)'}}>Praktische Tipps für weitere Bereiche</h2>
        <p className="text-sm mb-8 max-w-xl" style={{color: 'var(--muted)'}}>
          Ein sauberes Zuhause besteht aus vielen kleinen Details. Hier findest du einfache Tipps für weitere Räume und Bereiche.
        </p>

        <div className="grid sm:grid-cols-3 gap-5 mb-10">
          <div className="content-card p-6">
            <div className="rounded-xl overflow-hidden mb-4" style={{height:150}}>
              <img src="/images/wohnen-arbeitszimmer.jpg" alt="Arbeitszimmer" className="w-full h-full object-cover" />
            </div>
            <span className="category-icon-badge" style={{marginTop: -34, marginLeft: 0, marginBottom: '0.75rem'}}>
              <svg width="18" height="18" viewBox="0 0 64 64" fill="#5B21B6"><rect x="10" y="14" width="44" height="28" rx="5"/><rect x="15" y="19" width="34" height="18" rx="3" fill="#F5F3FF"/><rect x="5" y="48" width="54" height="7" rx="3.5"/></svg>
            </span>
            <p className="font-bold mb-2" style={{color: 'var(--ink)'}}>Arbeitszimmer</p>
            <p className="text-sm" style={{color: 'var(--muted)'}}>Schreibtisch, Regale und häufig genutzte Oberflächen regelmäßig abwischen. Anschließend den Boden saugen und Kabel sowie Gegenstände ordentlich verstauen.</p>
          </div>
          <div className="content-card p-6">
            <div className="rounded-xl overflow-hidden mb-4" style={{height:150}}>
              <img src="/images/wohnen-gaestezimmer.jpg" alt="Gästezimmer" className="w-full h-full object-cover" />
            </div>
            <span className="category-icon-badge" style={{marginTop: -34, marginLeft: 0, marginBottom: '0.75rem'}}>
              <svg width="18" height="18" viewBox="0 0 64 64" fill="#5B21B6"><rect x="5" y="36" width="54" height="19" rx="5"/><rect x="9" y="23" width="17" height="15" rx="5" opacity="0.4"/><path d="M5 36v-9a6 6 0 016-6h12a6 6 0 016 6v2h20a6 6 0 016 6v7" fill="none" stroke="#5B21B6" strokeWidth="4.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
            </span>
            <p className="font-bold mb-2" style={{color: 'var(--ink)'}}>Gästezimmer</p>
            <p className="text-sm" style={{color: 'var(--muted)'}}>Bett frisch beziehen, Oberflächen entstauben, gut lüften und den Boden gründlich reinigen. So ist der Raum jederzeit angenehm und einladend für deinen Besuch.</p>
          </div>
          <div className="content-card p-6">
            <div className="rounded-xl overflow-hidden mb-4" style={{height:150}}>
              <img src="/images/wohnen-weitere-bereiche.jpg" alt="Weitere Bereiche" className="w-full h-full object-cover" />
            </div>
            <span className="category-icon-badge" style={{marginTop: -34, marginLeft: 0, marginBottom: '0.75rem'}}>
              <svg width="18" height="18" viewBox="0 0 64 64" fill="#5B21B6"><path d="M6 20l26-13 26 13-26 13z"/><path d="M6 20v27l26 13V33z" opacity="0.65"/><path d="M58 20v27L32 60V33z" opacity="0.85"/></svg>
            </span>
            <p className="font-bold mb-2" style={{color: 'var(--ink)'}}>Weitere Bereiche</p>
            <p className="text-sm" style={{color: 'var(--muted)'}}>Auch Eingangsbereiche, Abstellräume oder Hauswirtschaftsräume regelmäßig aufräumen, Staub entfernen und den Boden reinigen. So bleibt dein gesamtes Zuhause gepflegt und ordentlich.</p>
          </div>
        </div>
        ...
        <div className="tip-banner flex items-center justify-between gap-6 p-7 md:p-8 overflow-hidden">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="font-bold text-lg mt-2 max-w-md leading-snug" style={{color: 'var(--ink)'}}>Ein ordentliches Zuhause sorgt überall für mehr Wohlbefinden.</p>
              <p className="text-sm mt-1 max-w-md" style={{color: 'var(--muted)'}}>Schon wenige Minuten pro Tag machen einen großen Unterschied.</p>
            </div>
          </div>
          <div className="hidden md:block w-24 h-28 rounded-2xl overflow-hidden shrink-0 -my-2">
            <img src="/images/plante.png" alt="" className="w-full h-full object-cover pointer-events-none select-none" />
          </div>
        </div>
      </section>
