...
export default function Page() {
  ...
  useEffect(() => {
    document.title = "TANDEF – Wohnzimmer richtig reinigen";
        ...
        <div className="article-hero flex flex-col lg:flex-row lg:min-h-[440px]">
          <div className="lg:w-1/2 p-8 md:p-12 flex flex-col justify-center">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold leading-tight mt-4 mb-5" style={{color: 'var(--ink)'}}>
              Wohnzimmer richtig reinigen
            </h1>
            <p className="text-base mb-6 max-w-md" style={{color: 'var(--muted)'}}>
              Ein sauberes Woknzimmer sorgt für mehr Wohlbefinden und eine angenehme Atmosphäre. Mit wenigen Schritten bleibt dein Wohnbereich gepflegt und einladend.
            </p>
          ...
          <div className="lg:w-1/2 h-56 sm:h-64 lg:h-auto overflow-hidden relative">
            <img src="/images/magazin-wohnen-wohnzimmer.jpg" alt="Wohnzimmer" className="w-full h-full object-cover block article-hero-img" />
            <span className="handwrite hidden lg:block absolute top-6 right-8 text-white text-right" style={{textShadow: '0 2px 10px rgba(0,0,0,.25)'}}>
              Ein schöneres<br />Zuhause – jeden Tag.
            </span>
          </div>
        </div>
      </section>
        ...
        <div className="grid sm:grid-cols-2 gap-5 mb-10">
          <div className="step-card grid grid-cols-2 items-stretch">
            <div className="p-6 flex flex-col justify-center">
              ...
              <p className="text-sm" style={{color: 'var(--muted)'}}>Lege Gegenstände an ihren Platz und schaffe freie Flächen. So lässt sich der Wohnbereich schneller und gründlicher reinigen.</p>
            </div>
          ...
          <div className="step-card grid grid-cols-2 items-stretch">
            <div className="p-6 flex flex-col justify-center">
              ...
              <p className="text-sm" style={{color: 'var(--muted)'}}>Entferne Staub von Möbeln, Regalen, Lampen und dekorativen Gegenständen mit einem geeigneten, leicht feuchten Tuch.</p>
            </div>
          ...
          <div className="step-card grid grid-cols-2 items-stretch">
            <div className="p-6 flex flex-col justify-center">
              ...
              <p className="font-bold mb-2" style={{color: 'var(--ink)'}}>Polster &amp; Textilien</p>
              <p className="text-sm" style={{color: 'var(--muted)'}}>Sauge Sofa, Sessel und Polster gründlich ab, um Staub, Krümel und Haare zu entfernen. Kissen und Decken nach Bedarf lüften oder waschen.</p>
            </div>
          ...
          <div className="step-card grid grid-cols-2 items-stretch">
            <div className="p-6 flex flex-col justify-center">
              ...
              <p className="text-sm" style={{color: 'var(--muted)'}}>Zum Schluss saugst du den Boden gründlich. Bei hartnäckigem Schmutz kannst du zusätzlich feucht wischen – je nach Bodenbelag mit einem passenden Reiniger.</p>
            </div>
            <div className="flex items-center justify-center" style={{background: '#E7F7EE', minHeight: '160px'}}>
            <img src="/images/asp.jpg"className="w-full h-full object-cover"  />
            </div>
          </div>
        </div>
        ...
        <div className="tip-banner flex items-center justify-between gap-6 p-7 md:p-8 overflow-hidden">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="font-bold text-lg mt-2 max-w-md leading-snug" style={{color: 'var(--ink)'}}>Ein aufgeräumtes Wohnzimmer wirkt größer, ruhiger und einladender.</p>
              <p className="text-sm mt-1 max-w-md" style={{color: 'var(--muted)'}}>Schon wenige Minuten am Tag machen einen großen Unterschied.</p>
            </div>
          </div>
         
          <div className="hidden md:flex items-center gap-3 shrink-0">
  <span className="handwrite text-right">Mehr Wohlfühlen<br />zuhause.</span>
     
</div>
<img src="/images/plante.png" alt="" className="pointer-events-none select-none w-30 opacity-90" />
